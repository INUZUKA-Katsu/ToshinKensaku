...
toshin_url.keys.each do |k|
  text_file = get_text_from(URL+toshin_url[k])
  bango,yyyymmdd,toshinbi,jisshikikan,bukai,iin,jorei,seikyu = get_midashi_data_from(text_file)
  num_array = get_num_array_from(bango)
  num       = num_array[0]
  midashi << [ num_array,bango,yyyymmdd,toshinbi,jisshikikan,bukai,iin,jorei,seikyu,text_file,toshin_kenmei[num],toshin_url[num] ]
end

midashi = midashi.sort_by{|a| a[0][0].to_i}
